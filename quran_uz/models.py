...
class Author(models.Model):
    ...
    profile_image = models.ImageField(upload_to='quran/uz/author/image/')
...
class Oyat(models.Model):
    ...
    audio = models.FileField(upload_to='quran/uz/audio/')
...
class Sura(models.Model):
    ...
    yozilgan_joyi = models.CharField(max_length=300, blank=True, null=True)

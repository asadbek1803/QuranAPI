    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quran_eng.author')),
            ],
            options={
                'verbose_name': 'Oyat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oyat', models.ManyToManyField(related_name='oyat', to='quran_eng.oyat')),
            ],
            options={
                'verbose_name': 'Sura',
